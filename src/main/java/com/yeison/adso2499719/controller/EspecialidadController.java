...
public class EspecialidadController {
	...
	@Autowired
	private IntEspecialidadService service;
	...
	// GUARDAR
	@PostMapping
	public ResponseEntity<?> save(@RequestBody Especialidad especialidad) throws Exception {
		try {
	...
	@PutMapping("{id}")
	public ResponseEntity<?> updated(@PathVariable Long id, @RequestBody Especialidad especialidad) throws Exception {
		try {
			service.updated(id, especialidad);

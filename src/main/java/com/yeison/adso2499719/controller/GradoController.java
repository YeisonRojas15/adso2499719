...
@RestController
@RequestMapping("appi/grado")
public class GradoController {
	
	@Autowired
	private IntGradoService service;
	...
	// GUARDAR
	@PostMapping
	public ResponseEntity<?> save(@RequestBody Grado grado) throws Exception {
		try {
	...
	@PutMapping("{id}")
	public ResponseEntity<?> updated(@PathVariable Long id, @RequestBody Grado grado) throws Exception {
		try {
			service.updated(id, grado);

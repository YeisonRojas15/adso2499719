...
@RestController
@RequestMapping("appi/profesor")
public class ProfesorController {
	
	@Autowired
	private IntProfesorService service;
	...
	// GUARDAR
	@PostMapping
	public ResponseEntity<?> save(@RequestBody Profesor profesor) throws Exception {
		try {
	...
	@PutMapping("{id}")
	public ResponseEntity<?> updated(@PathVariable Long id, @RequestBody Profesor profesor) throws Exception {
		try {
			service.updated(id, profesor);
			return ResponseEntity.ok("Regsitro actualizado"); 			
		} catch (Exception e) {
			return ResponseEntity.internalServerError().body(e.getMessage()); 
		}
	}
